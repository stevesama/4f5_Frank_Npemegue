...
/**
 * Precompiled local-fx-plugin script plugin.
 **/
public class LocalFxPluginPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        target.getPluginManager().apply("org.openjfx.javafxplugin");

        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_LocalFxPlugin").asSubclass(BasicScript.class);
